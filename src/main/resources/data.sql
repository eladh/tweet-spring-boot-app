...
VALUES
    (1, 'batman', 'Bruce Wayne', '1234'),
    (2, 'superman', 'Clark Kent' ,'1234'),
    (3, 'catwoman', 'Selina Kyle' ,'1234'),
    (4, 'daredevil', 'Matt Murdock' ,'1234'),
    (5, 'alfred', 'Alfred Pennyworth' ,'1234'),
    (6, 'dococ', 'Otto Octavius' ,'1234'),
    (7, 'zod', 'Dru-Zod' ,'1234'),
    (8, 'spiderman', 'Peter Parker' ,'1234'),
    (9, 'ironman', 'Tony Stark' , '1234'),
    (10, 'profx', 'Charles Xavier' ,'1234');
